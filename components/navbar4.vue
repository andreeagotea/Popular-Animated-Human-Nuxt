<template>
  <div class="navbar4-container"
    ><header data-thq="thq-navbar" class="navbar4-navbar-interactive"
      ><img :alt="logoAlt" :src="logoSrc" class="navbar4-image1" /><div
        data-thq="thq-navbar-nav"
        class="navbar4-desktop-menu"
        ><nav class="navbar4-links"
          ...
          ><span class="thq-link thq-body-small">{{ link5 }}</span></nav
        ><div class="navbar4-buttons"
          ><button class="thq-button-filled">{{ action1 }}</button
          ><button class="thq-button-outline">{{ action2 }}</button></div
        ></div
